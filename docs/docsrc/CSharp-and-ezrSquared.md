...
ezr² can be embedded into other programs. This allows your users to write scripts in ezr² which can control various systems in your app.
ezr² code is much simple and easier to learn and understand than, for example, C# code.

To learn more about embedding ezr² into your application, check the documentation [***here***](Embedding-ezrSquared.md)

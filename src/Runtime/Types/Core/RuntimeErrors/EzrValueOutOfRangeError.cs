...
[SharpTypeWrapper("value_out_of_range_error", nameof(WrapperConstructor))]
public class EzrValueOutOfRangeError(string details, Context context, Position startPosition, Position endPosition) : EzrRuntimeError("Value out of range", details, context, startPosition, endPosition)
{
    ...
    public static new void WrapperConstructor(SharpMethodParameters arguments)
    {
        ...
        result.Success(ReferencePool.Get(new EzrValueOutOfRangeError(details, arguments.ExecutionContext, arguments.StartPosition, arguments.EndPosition), AccessMod.PrivateConstant));
    }
}

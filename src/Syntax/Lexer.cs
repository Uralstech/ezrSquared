...
public class Lexer
{
    ...
    {
        _position.ReverseTo(index, _script[index] == '\n' ? 1 : 0);
        _currentChar = _script[_position.Index];
    }
        ...
        while (!_reachedEnd)
        {
            switch (_currentChar)
            {
                ...
                case '>':
                    ...
                    break;
                case '-':
                    tokens.Add(new Token(TokenType.HyphenMinus, TokenTypeGroup.Symbol, string.Empty, _position.Copy()));
                    Advance();
                    break;
                case '+':
    ...
    private Token CompileIdentifier(out EzrSyntaxError? error)
    {
        ...
        return isEscapedIdentifier
            ...
            "item"      => new Token(TokenType.KeywordItem, TokenTypeGroup.Keyword, string.Empty, startPosition, _position.Copy()),
            "and"       => new Token(TokenType.KeywordAnd, TokenTypeGroup.Keyword, string.Empty, startPosition, _position.Copy()),
            "or"        => new Token(TokenType.KeywordOr, TokenTypeGroup.Keyword, string.Empty, startPosition, _position.Copy()),
            "invert"    => new Token(TokenType.KeywordInvert, TokenTypeGroup.Keyword, string.Empty, startPosition, _position.Copy()),
            "if"        => new Token(TokenType.KeywordIf, TokenTypeGroup.Keyword, string.Empty, startPosition, _position.Copy()),
            ...
            "step"      => new Token(TokenType.KeywordStep, TokenTypeGroup.Keyword, string.Empty, startPosition, _position.Copy()),
            "while"     => new Token(TokenType.KeywordWhile, TokenTypeGroup.Keyword, string.Empty, startPosition, _position.Copy()),
            "function"  => new Token(TokenType.KeywordFunction, TokenTypeGroup.Keyword, string.Empty, startPosition, _position.Copy()),

#pragma warning disable CS0618
            "special"   => new Token(TokenType.KeywordSpecial, TokenTypeGroup.Keyword, string.Empty, startPosition, _position.Copy()),
#pragma warning restore CS0618
            ...
            "skip"      => new Token(TokenType.KeywordSkip, TokenTypeGroup.Keyword, string.Empty, startPosition, _position.Copy()),
            "stop"      => new Token(TokenType.KeywordStop, TokenTypeGroup.Keyword, string.Empty, startPosition, _position.Copy()),
            "try"       => new Token(TokenType.KeywordTry, TokenTypeGroup.Keyword, string.Empty, startPosition, _position.Copy()),
            "catch"     => new Token(TokenType.KeywordCatch, TokenTypeGroup.Keyword, string.Empty, startPosition, _position.Copy()),
            "not"       => new Token(TokenType.KeywordNot, TokenTypeGroup.Keyword, string.Empty, startPosition, _position.Copy()),
            "in"        => new Token(TokenType.KeywordIn, TokenTypeGroup.Keyword, string.Empty, startPosition, _position.Copy()),
            "object"    => new Token(TokenType.KeywordObject, TokenTypeGroup.Keyword, string.Empty, startPosition, _position.Copy()),
            "global"    => new Token(TokenType.KeywordGlobal, TokenTypeGroup.Keyword, string.Empty, startPosition, _position.Copy()),
            "include"   => new Token(TokenType.KeywordInclude, TokenTypeGroup.Keyword, string.Empty, startPosition, _position.Copy()),
            "all"       => new Token(TokenType.KeywordAll, TokenTypeGroup.Keyword, string.Empty, startPosition, _position.Copy()),
            "static"    => new Token(TokenType.KeywordStatic, TokenTypeGroup.Keyword, string.Empty, startPosition, _position.Copy()),
            "define"    => new Token(TokenType.KeywordDefine, TokenTypeGroup.Keyword, string.Empty, startPosition, _position.Copy()),
            "f"         => new Token(TokenType.QeywordF, TokenTypeGroup.Qeyword, original, startPosition, _position.Copy()),
            "l"         => new Token(TokenType.QeywordL, TokenTypeGroup.Qeyword, original, startPosition, _position.Copy()),
            "e"         => new Token(TokenType.QeywordE, TokenTypeGroup.Qeyword, original, startPosition, _position.Copy()),
            "c"         => new Token(TokenType.QeywordC, TokenTypeGroup.Qeyword, original, startPosition, _position.Copy()),
            "p"         => new Token(TokenType.QeywordP, TokenTypeGroup.Qeyword, original, startPosition, _position.Copy()),
            "t"         => new Token(TokenType.QeywordT, TokenTypeGroup.Qeyword, original, startPosition, _position.Copy()),
            "n"         => new Token(TokenType.QeywordN, TokenTypeGroup.Qeyword, original, startPosition, _position.Copy()),
            "w"         => new Token(TokenType.QeywordW, TokenTypeGroup.Qeyword, original, startPosition, _position.Copy()),
            "fd"        => new Token(TokenType.QeywordFd, TokenTypeGroup.Qeyword, original, startPosition, _position.Copy()),
            "sd"        => new Token(TokenType.QeywordSd, TokenTypeGroup.Qeyword, original, startPosition, _position.Copy()),
            "sb"        => new Token(TokenType.QeywordSb, TokenTypeGroup.Qeyword, original, startPosition, _position.Copy()),
            "od"        => new Token(TokenType.QeywordOd, TokenTypeGroup.Qeyword, original, startPosition, _position.Copy()),
            "i"         => new Token(TokenType.QeywordI, TokenTypeGroup.Qeyword, original, startPosition, _position.Copy()),
            "s"         => new Token(TokenType.QeywordS, TokenTypeGroup.Qeyword, original, startPosition, _position.Copy()),
            "d"         => new Token(TokenType.QeywordD, TokenTypeGroup.Qeyword, original, startPosition, _position.Copy()),
